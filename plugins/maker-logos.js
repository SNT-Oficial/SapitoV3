...
if (!effect) throw '*[❗𝐈𝐍𝐅𝐎❗] 𝐂𝐨𝐦𝐨 𝐮𝐬𝐚𝐫 𝐞𝐬𝐭𝐞 𝐜𝐨𝐦𝐚𝐧𝐝𝐨 𝐝𝐞 𝐦𝐢𝐞𝐫𝐝𝐚?*\n—◉ _#logo (efecto) (texto)_\n*𝙴𝙹𝙴𝙼𝙿𝙻𝙾:*\n—◉ _#logo 3d-deep-sea-metal Sapito_\n\n*[❗] 𝐂𝐮𝐚𝐧𝐝𝐨 𝐥𝐞𝐬 𝐝𝐢𝐠𝐚 𝐪𝐮𝐞 𝐡𝐚𝐜𝐞 𝐟𝐚𝐥𝐭𝐚 𝐮𝐧 𝐭𝐞𝐱𝐭𝐨 𝐬𝐞𝐫𝐢𝐚 :*\n—◉ _#logo (efecto) (texto1|texto2)_\n*𝙴𝙹𝙴𝙼𝙿𝙻𝙾:*\n—◉ _#logo Wolf-Logo-Galaxy Sapito|Bot_\n\n*<𝑳𝑰𝑺𝑻𝑨 𝑫𝑬 𝑬𝑭𝑬𝑪𝑻𝑶𝑺/>*\n\n° ඬ⃟📝 #logo ' + effects.map(v => v.title).join('\n° ඬ⃟📝 #logo ')
...
if (typeof res == 'number') throw res == -1 ? `*[❗𝐈𝐍𝐅𝐎❗] 𝐄𝐥 𝐞𝐟𝐞𝐜𝐭𝐨 ${effect} 𝐍𝐨 𝐞𝐬𝐭𝐚 𝐞𝐧 𝐥𝐚 𝐥𝐢𝐬𝐭𝐚 𝐝𝐞 𝐒𝐚𝐩𝐢𝐭𝐨 𝐁𝐨𝐭*` : `*[❗𝐈𝐍𝐅𝐎❗] 𝐄𝐋 𝐮𝐬𝐨 𝐜𝐨𝐫𝐫𝐞𝐜𝐭𝐨 𝐞𝐬 ${usedPrefix + command} ${effect} ${new Array(res).fill('texto').map((v, i) => v + (i ? i + 1 : '')).join('|')}*`
let result = await axios.get(res, {
responseType: 'arraybuffer'
})
await conn.sendFile(m.chat, result.data, 'Error.jpg', `*𝐓𝐨𝐦𝐚 𝐭𝐮 𝐢𝐦𝐚𝐠𝐞𝐧 𝐩𝐞𝐫𝐬𝐨𝐧𝐚𝐥𝐢𝐳𝐚𝐝𝐚 𝐩𝐨𝐫 𝐒𝐚𝐩𝐢𝐭𝐨𝐁𝐨𝐭!!*\n*𝐄𝐟𝐞𝐜𝐭𝐨: ${effect}*`, m)
}
handler.help = ['logos']
handler.tags = ['nulis']
