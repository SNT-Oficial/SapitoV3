...
║    ◉— *𝐒𝐚𝐩𝐢𝐭𝐨 𝐁𝐨𝐭* —◉
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡║
║➤ *𝐉𝐎𝐥𝐚, ${taguser}* 𝐜𝐨𝐦𝐨 𝐞𝐬𝐭𝐚𝐬?
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡║
║➤ *𝐂𝐫𝐞𝐚𝐝𝐨𝐫 𝐝𝐞𝐥 𝐛𝐨𝐭:* 🇸 🇳 🇹 
║➤ *𝐍𝐮𝐦𝐞𝐫𝐨 𝐝𝐞𝐥 𝐜𝐫𝐞𝐚𝐝𝐨𝐫:* wa.me/595983186566
║➤ *𝐍𝐮𝐦𝐞𝐫𝐨 𝐝𝐞𝐥 𝐛𝐨𝐭 𝐨𝐟𝐢𝐜𝐢𝐚𝐥:* wa.me/
║➤ *Fecha:* ${date}
...
`.trim()
let buttons = [
{ buttonId: 'sexo', buttonText: { displayText: 'sexo' }, type: 2 },
...
conn.reply(m.chat, '*[❗𝐈𝐍𝐅𝐎❗] 𝐞𝐥 𝐦𝐞𝐧𝐮 𝐭𝐢𝐞𝐧𝐞 𝐞𝐫𝐫𝐨𝐫 𝐮𝐬𝐞 #𝐫𝐞𝐩𝐨𝐫𝐭*', m)
}}
